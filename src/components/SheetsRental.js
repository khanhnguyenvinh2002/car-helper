...
function SheetsRental () {
	...
	const onSubmit  = async ({location,maker,mileage,budget, subscription, number}) => {

		const objt = {Location: location,Maker: maker,Mileage:mileage,Budget:budget, Subscription: subscription, Number: number};
		...
		<div className="">
			...
			<div className="form-group">
				<Controller
					...
					defaultValue=""/>
				{errors.maker?.type === "required" && <div className="errorText">Email is required.</div>}
			</div>
			...
			<div className="form-group">
				<Controller
					...
					defaultValue=""
				/>
				{errors.budget?.type === "required" && <div className="errorText">Budget is required.</div>}
			</div>
			...
			<div className="form-group">
				<Controller
                    ...
                    <option value="">How long are you going to rent a car?</option>
                    <option value="3months">3 months with 3 free car-wash coupons</option>
                    <option value="6months">6 months with 10 free car-wash coupons and 2% off</option>
                    <option value="1year">1 year with 15 free car-wash coupons and 5% off</option>
                    <option value="1.5year">1.5 years with 20 free car-wash coupons and 10% off and 4 free repairing tickets</option>
                    <option value="2years">2 years with 25 free car-wash coupons and 20% off and 10 free repairing tickets</option>
                     </select>
					)}
					name="subscription"
					rules={{ required: true}}
					defaultValue=""
				/>
				{errors.subscription?.type === "required" && <div className="errorText">Subscription is required.</div>}
			</div>
